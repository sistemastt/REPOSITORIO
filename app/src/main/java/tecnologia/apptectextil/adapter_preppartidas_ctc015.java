...
public class adapter_preppartidas_ctc015  extends BaseAdapter {
    ...
    public adapter_preppartidas_ctc015(Context contx,int[] Imagenes, String[] Evento, String[] Evento_detalle, String[] Evento_id) {
        context=contx;
        iImagenes=Imagenes;
        this.Evento=Evento;
