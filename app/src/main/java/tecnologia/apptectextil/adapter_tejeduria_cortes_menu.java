...
public class adapter_tejeduria_cortes_menu  extends BaseAdapter {
    ...
    public adapter_tejeduria_cortes_menu(Context contx,int[] Imagenes, String[] Evento, String[] Evento_detalle, String[] Evento_id) {
        context=contx;
        iImagenes=Imagenes;
        this.Evento=Evento;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.lista_tejeduria_cortes_menu, parent, false);
